#ifndef Analysis_SemiMergHad_H
#define Analysis_SemiMergHad_H
...
class Analysis_SemiMergHad : public Analysis
{
public:

  // Constructor
  Analysis_SemiMergHad(Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref, Cutflow &cutflow_ref)
  ...
  void initCutflow() override
  {
    ...
    // specify tighter Run 2 selection
    ...
    Cut *cut_AtLeast2AK8Jets = new LambdaCut(
        ...
        [&]()
        {
          return (cutflow.globals.getVal<int>("n_ak8jets_run2sel") >= 2);
        });
